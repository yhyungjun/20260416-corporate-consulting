...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  // ── Part B: 프로세스 & 도구 & 데이터 성숙도 ────────────────────────────
  {
    ...
    questionText: '프로세스 표준화 수준',
    answerType: 'single',
    options: ['비표준', '부분 표준화', '표준화 정착', '지속 개선', '최적화'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '병목 현상과 반복 업무',
    answerType: 'single',
    options: ['매우 심함', '자주 발생', '때때로', '거의 없음', '최적화됨'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '자동화/RPA 인프라',
    answerType: 'single',
    options: ['없음', '극소', '부분', '구축', '고도화'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '도구 활용 수준',
    answerType: 'single',
    options: ['낮음', '부분적', '중간', '높음', '최적화'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: 'AI 도구 인프라 및 활용',
    answerType: 'single',
    options: ['없음', '시기', '시범', '운영', '고도화'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '데이터 저장 및 관리',
    answerType: 'single',
    options: ['매우 분산', '분산', '부분 통합', '중앙화', '완전 통합'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '데이터 수집 및 거버넌스',
    answerType: 'single',
    options: ['없음', '초기', '부분', '공식', '고도화'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: 'AX 비전 및 전략',
    answerType: 'single',
    options: ['관심 없음', '인식', '계획', '추진', '전략'],
  ...
  },
  {
    ...
    part: 'B',
    partLabel: '프로세스 & 도구 & 데이터 성숙도',
    questionText: '조직 내 학습 및 변화 수용 문화',
    answerType: 'single',
    options: ['저항 높음', '부분 저항', '중립', '수용', '주도적'],
  ...
  },
  {
    ...
    part: 'C',
    partLabel: 'Pain Point & 자동화 희망',
    questionText: '가장 힘든 상황/Pain Point',
    answerType: 'text',
  ...
  },
  {
    ...
    part: 'C',
    partLabel: 'Pain Point & 자동화 희망',
    questionText: '자동화 희망 업무',
    answerType: 'text',
    purpose: '고객이 직접 제시하는 과제 → 참여도 높고 현실성 높은 과제',
    reportSections: ['P10'],
  ...
  },
  {
    ...
    purpose: '파일럿 1단계 범위 설정 → 로드맵 Phase 1 부서 확정',
    reportSections: ['P9', 'P10', 'P12'],
    reportFieldKeys: ['targetDepts'],
  },
  {
    id: 'I7',
    part: 'I',
    partLabel: '업무 운영 & 병목 진단',
    questionText: '해당 부서 인원 수',
    answerType: 'text',
    purpose:
      '파일럿 대상 인원 확정 → 교육 규모 및 라이선스 비용 산정 근거',
    reportSections: ['P9', 'P12', 'P13'],
    reportFieldKeys: ['targetDepts'],
  },
  {
    ...
    part: 'I',
    partLabel: '업무 운영 & 병목 진단',
    questionText: '부서 핵심 반복 업무 Top 3',
    answerType: 'text',
    purpose:
      '과제 발굴의 핵심 원천 데이터 — 구체 업무명이 혁신 과제 제목으로 직접 연결',
    reportSections: ['P5', 'P10'],
    reportFieldKeys: ['painPoints', 'innovationTasks'],
  },
